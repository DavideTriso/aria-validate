(function (factory) {
    ...
    $.fn[pluginName].autoformatFunctions = {
        ...
        insertCharAt: function (fieldValue, param) {
             ...
             *     }
             */
            if (fieldValue.length <= param.index) {
                return;
            }
        ...
        insertCharEvery: function (fieldValue, param) {
            /*
             *@TODO: refactor function to make it usable on 'input' event (while typing)
             *
             ...
             *     }
             */
            if (fieldValue.length <= param.delta) {
                return;
            }
